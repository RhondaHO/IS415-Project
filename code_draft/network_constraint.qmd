...
```{r}
# set directory
setwd("data/rds/facilities/combined/hdb_carpark")
...
setwd("data/rds/kfunc/supermarket/multi")

# get data
area_name <- area_names[25]

# CHANGE NAME BELOW!!!!
hdb_facility <- get(paste0("hdb_supermarket_", area_name))
hdb_facility_points <- hdb_facility %>% select(c("geometry"))
area_network <- get(paste0("network_", area_name))
...
kfunc_name <- paste0("kfunc_supermarket_", area_name, ".rds")
